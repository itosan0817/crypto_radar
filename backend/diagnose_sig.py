...
safe_print("=== Aerodrome NotifyRewardシグネチャ診断 ===")
safe_print("")
...
async def check_known_contract():
    ...
    safe_print(f"\n最新ブロック: {latest}")
    safe_print("既知のBribeコントラクトで過去100ブロックを検索...\n")
